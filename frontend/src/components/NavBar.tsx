...
import { FaBell, FaHome, FaStore } from "react-icons/fa";
...
function Navbar() {
  ...
  return (
    <>
      <nav className="bg-white dark:bg-neutral-950 h-max md:h-14 w-full shadow flex flex-col md:flex-row items-center justify-center md:justify-between fixed top-0 z-50 border-b dark:border-neutral-800">
        {/*<!-- LEFT NAV -->*/}
        ...
        {/* RIGHT NAV */}
        <ul className="hidden md:flex mx-4 items-center justify-center space-x-4">
          <AvatarUser />

          <li>
            <button
              onClick={setdarkMode}
              className="text-xl grid place-items-center bg-gray-200 dark:bg-neutral-700 dark:text-slate-300 rounded-full p-2 cursor-pointer hover:bg-gray-300 hover:dark:bg-neutral-600 relative"
            >
          ...
          <li>
            <div className="text-xl hidden xl:grid place-items-center bg-gray-200 dark:bg-neutral-700 dark:text-slate-300 rounded-full p-2 cursor-pointer hover:bg-gray-300 hover:dark:bg-neutral-600 relative">
              <BiMessageRoundedDetail />
            </div>
          </li>
          <li>
            <div className="text-xl grid place-items-center bg-gray-200 dark:bg-neutral-700 dark:text-slate-300 rounded-full  p-2 cursor-pointer hover:bg-gray-300 hover:dark:bg-neutral-600 relative">
              <FaBell />
              <span className="text-xs absolute top-0 right-0 bg-red-500 text-white font-semibold rounded-full  text-center">
                9
              </span>
            </div>
          </li>
