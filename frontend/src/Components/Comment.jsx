      ...
      <div>
        ...
        <div className="pt-1 mx-3 text-xs text-gray-500 dark:text-slate-300 flex justify-between">
          <div className="flex justify-center">
            <div className="rounded-md bg-gray-200 dark:bg-neutral-700 hover:dark:bg-neutral-600 w-9 h-4 cursor-pointer flex justify-center">
              <span
                className={
            ...
            <div className="rounded-md bg-gray-200 dark:bg-neutral-700 hover:dark:bg-neutral-600 w-11 h-4 cursor-pointer flex justify-center">
