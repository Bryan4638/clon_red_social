  ...
  return (
    <section className="min-h-screen flex items-stretch text-white ">
      <div className="w-full flex items-center justify-center text-center px-0 z-0 bg-gray-800">
        <div className=" w-1/3 py-6 z-20 rounded-xl bg-gray-900 ">
          <div className=" mb-6 py-2">
            <h1 className=" text-white text-6xl font-bold">Register</h1>
          </div>
          {registerErrors.map((error, i) => (
            <div
              className=" bg-rose-500 text-white p-2 bg-red-400 rounded-2xl mx-auto w-2/3"
              key={i}
            >
              {error}
            </div>
          ...
          >
            ...
            <div className="px-4 pb-2 pt-4">
              <button
                type="submit"
                className="uppercase block w-full p-4 text-lg rounded-2xl bg-indigo-500 hover:bg-indigo-600 focus:outline-none"
              >
                sign up
              </button>
            </div>
          ...
          <div className=" text-center ">
            <span className="text-xl text-white">I have an account?</span>
            <Link
              to={"/login"}
