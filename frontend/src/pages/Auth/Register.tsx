            ...
            >
              <div>
                ...
                <input
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-emerald-600 focus:border-emerald-600 block w-full p-2.5 dark:bg-emerald-950 dark:border-emerald-800 dark:placeholder-neutral-200 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500"
              ...
              <button
                type="submit"
                className="w-full text-white bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-emerald-500 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800"
              >
                Sign up
              </button>
