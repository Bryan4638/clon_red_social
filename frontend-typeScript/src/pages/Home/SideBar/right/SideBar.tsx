      ...
      <div className="w-1/5 pt-16 h-full hidden xl:block px-4 fixed top-0 right-0">
        <div className="h-full">
          <div className="flex justify-between items-center px-4 pt-4">
            ...
            <span className="text-emerald-500 cursor-pointer hover:bg-gray-200 dark:hover:bg-neutral-900 p-2 rounded-md">
              See All
            </span>
          </div>
          <div className="p-2">
            <a
              href="#"
              className="flex items-center space-x-4 p-2 hover:bg-gray-200 dark:hover:bg-neutral-900 rounded-lg transition-all"
            >
              <img
          ...
          <div className="border-b border-gray-200 dark:border-neutral-900 mt-6"></div>
          {/* <!-- CONTACTS --> */}
